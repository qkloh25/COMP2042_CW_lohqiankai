...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		BackgroundImage froggerback = new BackgroundImage("file:src/p4_group_8_repo/pics/iKogsKW.png");
	    
		background.add(froggerback);
		
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 0, 160, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 220, 160, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 440, 160, 0.75));
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/pics/logs.png", 270, 0, 260, -2));
		background.add(new Log("file:src/p4_group_8_repo/pics/logs.png", 270, 400, 260, -2));
		//background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 800, 276, -2));
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 50, 305, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 270, 305, 0.75));
		background.add(new Log("file:src/p4_group_8_repo/pics/log3.png", 135, 490, 305, 0.75));
		...
		animal = new Animal("file:src/p4_group_8_repo/pics/froggerUp.png");
		background.add(animal);
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/truck1"+"Right.png", 0, 655, 1, 110, 110));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/truck1"+"Right.png", 300, 655, 1, 110, 110));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/truck1"+"Right.png", 600, 655, 1, 110, 110));
		//background.add(new Obstacle("file:src/p4_group_8_repo/truck1"+"Right.png", 720, 649, 1, 120, 120));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 100, 605, -1, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 250, 605, -1, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 400, 605, -1, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 550, 605, -1, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/truck2Right.png", 0, 555, 1, 200, 200));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/truck2Right.png", 500, 555, 1, 200, 200));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 500, 505, -5, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/pics/car1Left.png", 500, 455, 4, 50, 50));
